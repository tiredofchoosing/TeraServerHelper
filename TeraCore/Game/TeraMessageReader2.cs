...
namespace TeraCore.Game
{
    ...
    public class TeraMessageReader2 : BinaryReader
    {
        public TeraMessageReader2(Message message, OpCodeNamer opCodeNamer, MessageFactory factory, OpCodeNamer sysMsgNamer)
        ...
        public TeraMessageReader2(Message message) : base(GetStream(message), Encoding.Unicode)
        {
            Message = message;
        }
